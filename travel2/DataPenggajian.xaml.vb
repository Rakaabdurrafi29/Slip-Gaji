...
Public Class DataPenggajian
    ...
    Private Sub LoadData()
        ...
        Dim query As String = "SELECT `No`, `Name`, `Golongan`, `JumlahHariKerja`, `Employee ID`, `JumlahJamLembur`, `GajiLembur`, `PotonganAlpa`, `GajiBersih`, `Alpa`, `GajiPokok`, `TunjanganJabatan`, `TunjanganMakan`, `TunjanganTransportasi`, `Hadir`, `Izin` FROM `tpenggajian`"
