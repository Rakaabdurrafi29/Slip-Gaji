...
Public Class DataBiodata
    ...
    Private Sub LoadData()
        ...
        Dim query As String = "SELECT `No`, `EmployeeId`, `Name`, `JobTitle`, `Golongan`, `Gender`, `HireDate`, `Phone`, `Email`, `BirthDate`, `GajiPokok`, `TunjanganJabatan`, `TunjanganMakan`, `TunjanganTransportasi`, `GajiLembur`, `PotonganAlpa`, `GajiBersih` FROM `tboidata`"
